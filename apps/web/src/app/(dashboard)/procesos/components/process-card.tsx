...
export function ProcessCard({ process }: { process: MeasurementProcessModel }) {
  ...
  return (
    <Link
      href={ROUTES.proceso(process.id)}
      className="focus-visible:ring-ring group block rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
    >
      <Card className="group-hover:border-primary/40 h-full transition-colors">
        <CardHeader className="pb-3">
          <div className="flex flex-wrap items-start justify-between gap-2">
            <div className="min-w-0">
              <CardTitle className="text-base group-hover:underline">{process.name}</CardTitle>
