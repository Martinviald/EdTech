...
const DEMO_ORG_ID = 'b3c00000-0000-0000-0000-000000000001'; // Colegio Andes Centro (red demo)
const DEMO_USER_IDS = {
  teacher: 'dec00000-0000-0000-0000-0000000000c1',
};
const DEMO_AY_2026_ID = 'a3e00000-0000-0000-0000-000000000071'; // año 2026 isCurrent (Andes)

// Namespace de UUID para todo lo que crea este seed (borrado idempotente).
const NS = 'a3e00000-0000-0000-0000-';
...
async function main() {
  ...
  // ── 3. Años académicos (Andes no tiene AY previo → creamos los 3, 2026 vigente) ─
  ...
  await db.insert(academicYears).values([
    ...
    { id: AY[2026], orgId: DEMO_ORG_ID, year: 2026, isCurrent: true },
  ]);
  ...
  // (Andes) Sin asignaciones de profesor: la vista directiva/school_admin no las
  // requiere, y el profesor demo pertenece a Colegio Demo (no a Andes).
  ...
  // aplicación es un cuadernillo distinto. Compartir un instrumento entre momentos
  // deja `application_period` en NULL y el filtro de "Momento" de /resultados no
