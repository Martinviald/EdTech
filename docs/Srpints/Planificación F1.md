...
## Sprint 0 — Cimientos arquitectónicos *(Semanas 1-2)*
...
## Sprint 1 — Onboarding del colegio *(Semanas 3-4)*
...
## Sprint 2 — Banco de ítems + Pautas DIA *(Semanas 5-6)*
...
## Sprint 3 — Ingesta y corrección DIA *(Semanas 7-8)*
...
## Sprint 4 — Dashboards core *(Semanas 9-10)*
...
## Sprint 5 — Dashboards avanzados + Flujo demo completo *(Semanas 11-12)*
...
*Documento generado: 2026-05-16 · Actualizar al final de cada sprint con lo completado, lo diferido y las decisiones tomadas.*
